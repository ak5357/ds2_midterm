...
p_smoking = ggplot(dat1_decoded, aes(x = smoking)) + 
  geom_bar(fill = "skyblue") + 
...
barplot_combined = ggarrange(p_gender, p_race, p_smoking, p_diabetes, p_hypertension, nrow = 3, ncol = 2)
...
p_sbp = ggplot(dat1_decoded, aes(x = sbp)) + 
  geom_histogram(fill = "skyblue", color = "black", lwd = 0.5) + 
  labs(title = "SBP Distribution", x = "Systolic Blood Pressure", y = "Count")

p_ldl = ggplot(dat1_decoded, aes(x = ldl)) + 
  geom_histogram(fill = "orange", color = "black", lwd = 0.5) + 
  labs(title = "LDL Cholesterol Distribution", x = "LDL Cholesterol", y = "Count")

p_time = ggplot(dat1_decoded, aes(x = time)) + 
  geom_histogram(fill = "skyblue", color = "black", lwd = 0.5) + 
  labs(title = "Time Since Vax Distribution", x = "Time Since Vaccination", y = "Count")
...
featurePlot(x = dat1[, c("age", "height", "weight", "bmi", "sbp", "ldl", "time")], dat1$log_antibody, plot = "scatter", labels = c("", "Y"),
...
gam_rmse_dat1 = sqrt(mean((gam_pred - testing_data$log_antibody)^2))
...
gam_rmse_dat2 = sqrt(mean((gam_pred - dat2$log_antibody)^2))
